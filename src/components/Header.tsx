          ...
          <nav className="hidden md:flex items-center gap-1">
            {NAV_ITEMS.map((item) => (
              <a
                ...
                className="px-4 py-2 text-sm font-medium text-muted-foreground hover:text-foreground transition-colors duration-300 rounded-md"
              >
                {item.label}
              </a>
            ))}
          ...
          <nav className="flex flex-col px-4 py-4 space-y-1">
            {NAV_ITEMS.map((item) => (
              <a
                ...
                href={item.href}
                onClick={(e) => handleNavClick(e, item.href)}
                className="px-4 py-3 text-sm font-medium rounded-md text-foreground hover:bg-muted transition-colors"
              >
                {item.label}
              </a>
            ))}
